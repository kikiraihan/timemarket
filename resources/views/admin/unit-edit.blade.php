    ...
    <x-organism.dropup-admin>
        ...
        <x-slot name="pilihanButton">
            <div class="flex space-x-1 px-1">
                <button wire:click="tampilData({{$idToDropUp}})" class="flex-auto p-2 rounded bg-gray-300 shadow-sm focus:outline-none focus:ring-1 ring-gray-500">Batal</button>
                <button wire:click="updateUnit()" class="flex-auto p-2 rounded bg-green-300 shadow-sm focus:outline-none focus:ring-1 ring-green-500">Simpan</button>
            </div>
        </x-slot>
        ...
        <div class="flex flex-col">
            ...
            <h5 class="font-bold mb-3 ml-3 uppercase">Edit Unit</h5>
            ...
            <ul class="divide-y-2 divide-gray-100 border-b border-t border-green-100">
                ...
                <li class="p-2">
                    ...
                    <div >
                        ...
                        @if ($searchKanit)
                        <span class="block text-xs mt-2 text-gray-400 pl-1">Ditemukan : {{$alternatifKanit->count()}}</span>
                        @endif
                    </div>
                    ...
                    <div>
                        ...
                        <button type="button" wire:click="batalkanKanit" class="shadow mt-4 bg-red-400 p-2 rounded text-white">Batalkan</button>
                    </div>
                    @endif
                    ...
                    <div >
                        ...
                        @if ($searchKatim)
                        <span class="block text-xs mt-2 text-gray-400 pl-1">Ditemukan : {{$alternatifKatim->count()}}</span>
                        @endif
                    ...
                    <div>
                        ...
                        <button type="button" wire:click="batalkanKatim" class="shadow mt-4 bg-red-400 p-2 rounded text-white">Batalkan</button>
                    </div>
                    @endif
