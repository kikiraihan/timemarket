            ...
            <div class="w-full overflow-hidden">
                ...
                <div class="grid grid-cols-8 w-full text-sm">
                    <div class="p-1 text-center text-gray-300">
                        {{-- <img class="rounded bg-white p-1 w-10 h-10 flex justify-center items-center" src="{{$item['pegawai']->user->gravatar}}"> --}}
                        <div class="rounded bg-white p-1 w-10 h-10 flex justify-center items-center">
                            {{$item['pegawai']->nama_singkat}}
                        </div>
                    </div>
                    ...
                    @foreach ($seminggu as $minggu)
                        ...
                        <div class="bg-white text-center text-gray-500 border border-gray-200 f-roboto">
                            ...
                            <div class="flex flex-col space-y-0">
                                ...
                                <div class="flex-1">
                                    <div class="flex items-center justify-end space-x-1">
                                        ...
                                        <span class="material-icons text-yellow-300 absolute animate-ping" style="font-size: 12px">
                                            circle
                                        </span>
                                        @endif
                                    ...
                                    <div class="flex-1">
                                        <div class="flex flex-col flex-wrap">
                                            ...
                                            style="font-size: 10px;">
                                                {{-- {{$tugashariini->judul}}
                                                - --}}
                                                {{$tugashariini->namatim}}. {{$tugashariini->level}}
                                            </span>
                                        </div>
                                    </div>
                                @endforeach
