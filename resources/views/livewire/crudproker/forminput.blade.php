<div>
    ...
    <div class="container mx-auto flex flex-col space-y-4 py-4">
        ...
        <div class="px-4">
            ...
            <x-input-standar-kiki wire:model.lazy='judul' id="judul" placeholder="Bahan Bakar Minyak"/>
        ...
        <div class="px-4">
            ...
            <x-select-standar-kiki wire:model.lazy="jangka" id="jangka">
                <option value="" hidden selected>Pilih jangka</option>
        ...
        <div class="px-4">
            ...
            <x-select-standar-kiki wire:model.lazy="iku" id="iku">
                <option value="" hidden selected>Pilih IKU atau non IKU</option>
        ...
        <div class="px-4">
            ...
            <x-input-standar-kiki wire:model.lazy='target_pelaksaan' id="target_pelaksaan" placeholder="Minggu pertama awal bulan"/>
            <x-error-input :kolom="'target_pelaksaan'"/>
        </div>
        ...
        @else
        <div class="px-4">
            <label class="f-roboto ml-1 text-gray-500 text-sm">Pilih Kepala</label>
